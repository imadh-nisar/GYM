...
if (!isset($_SESSION['user_id'])) {
  ...
  <body>
    <div class="container py-5">
      <h1 class="text-center text-primary mb-4">🏋️ Uni Gym Portal</h1>
...
<body>
  <div class="container py-5">
    <h2 class="text-center text-white mb-4">Welcome, <?= $_SESSION['user_name'] ?> 👋</h2>

    <?php if (empty($userData['weight']) || empty($userData['height'])): ?>
      <!-- Measurement Form -->
      <form class="card p-3 shadow mb-4" method="POST">
        <h4>Enter Your Sizes</h4>
        <input type="number" step="0.1" name="weight" class="form-control mb-2" placeholder="Weight (kg)" required>
        <input type="number" step="0.01" name="height" class="form-control mb-2" placeholder="Height (m)" required>
        <input type="number" name="chest" class="form-control mb-2" placeholder="Chest (cm)">
        <input type="number" name="waist" class="form-control mb-2" placeholder="Waist (cm)">
        <input type="number" name="arms" class="form-control mb-2" placeholder="Arms (cm)">
        <input type="number" name="legs" class="form-control mb-2" placeholder="Legs (cm)">
    ...
    <?php else: ?>
                ...
                <div class="card h-100 border-<?= $plan['type'] === 'rest' ? 'secondary' : 'primary' ?>">
                  ...
                  <div class="card-body p-2 d-flex flex-column">
                    <?php if ($plan['type'] === 'rest'): ?>
                      ...
                      <button type="button" class="btn btn-sm btn-outline-light mt-auto" onclick="startWorkoutForDay('<?= addslashes($day) ?>')">Start Light Stretch</button>
                    <?php else: ?>
                      ...
                      <button type="button" class="btn btn-sm btn-outline-light mt-auto" onclick="startWorkoutForDay('<?= addslashes($day) ?>')">Start</button>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
      ...
      <button class="btn btn-primary mt-3" onclick="startServerWorkout()">Start Workout</button>
    <?php endif; ?>
