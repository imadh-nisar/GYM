...
// Simple landing page for UniGym
...
<head>
    ...
    <title>UniGym | Campus Fitness Center</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    <link rel="stylesheet" href="assets/css/style.css">
    <style>
        .hero {
            background: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url('https://images.unsplash.com/photo-1554284126-aa88f22d8f2d?auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
            min-height: 85vh;
        }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">UniGym</a>
    ...
    <header class="hero d-flex align-items-center">
        <div class="container text-white">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h1 class="display-4 fw-bold">Your Campus. Your Gym. Your Goals.</h1>
        ...
        <section id="about" class="py-5">
            <div class="container">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <h2>What Makes UniGym Unique?</h2>
                        <p class="lead">UniGym is designed for students, staff, and faculty. Whether you’re focused on
        ...
        <section id="gallery" class="py-5">
            <div class="container">
                ...
                <div class="row g-3 gallery">
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1558611848-73f7eb4001e5?auto=format&fit=crop&w=1200&q=80"
                            alt="Weight machines" class="rounded shadow-sm">
                    </div>
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1605296867304-46d5465a13f1?auto=format&fit=crop&w=1200&q=80"
                            alt="Cardio equipment" class="rounded shadow-sm">
                    </div>
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1517964102950-36a2f43d6b7c?auto=format&fit=crop&w=1200&q=80"
                            alt="Group workout" class="rounded shadow-sm">
                    </div>
                </div>
            </div>
        </section>

        <section id="hours" class="py-5 bg-light">
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>Email:</strong> <a href="mailto:fit@unigym.edu"
                                    class="text-white">fit@unigym.edu</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <footer class="py-4 bg-black text-white">
        <div class="container text-center">
            <p class="mb-1">© <?= date('Y'); ?> UniGym. All rights reserved.</p>
