...
<head>
  <title>Admin Dashboard - Uni Gym</title>
              ...
              <div class="col">
                <div class="card h-100">
                  <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted mb-3"><small>Added: <?= htmlspecialchars($admin['created_at']) ?></small></p>
                    <form method="POST" class="mt-auto" onsubmit="return confirm('Remove this admin?');">
